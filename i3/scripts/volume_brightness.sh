...
function show_brightness_notif {
  brightness=$(echo "$(get_brightness) * 100"| bc)
  actual_bright=$(printf "%.0f" "$brightness")
    get_brightness_icon
    dunstify -t 1000 -r 2593 -u normal "$brightness_icon $actual_bright%" -h int:value:$actual_bright -h string:hlcolor:$bar_color
}
